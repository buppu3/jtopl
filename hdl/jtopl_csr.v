...
module jtopl_csr #(
    parameter LEN=18, W=34, OPL_TYPE=1, WAVESEL_WIDTH = 0
...
generate if (OPL_TYPE == 2 || OPL_TYPE == 3) begin
assign regop_in[WAVESEL_WIDTH-1+32:32] = up_wav_I ? din[WAVESEL_WIDTH-1:0] : shift_out[WAVESEL_WIDTH-1+32:32];
end
endgenerate
